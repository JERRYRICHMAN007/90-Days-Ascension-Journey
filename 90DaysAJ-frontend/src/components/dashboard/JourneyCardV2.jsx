          ...
          <div className="relative z-10 flex flex-col flex-1">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-3 flex-1 min-w-0">
                <div className={`w-12 h-12 rounded-lg ${colors.iconBg} flex items-center justify-center shrink-0`}>
                  <Icon className="w-6 h-6 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-xl font-bold text-foreground mb-1 line-clamp-1">{journey.title}</h3>
            ...
            <div className="grid grid-cols-3 gap-3 mt-auto">
              ...
              <div className="flex flex-col items-center p-2 rounded-lg bg-muted/30">
                <Star className="w-4 h-4 text-xp mb-1" />
                <span className="text-lg font-bold text-foreground tabular-nums">
              ...
              <div className="flex flex-col items-center p-2 rounded-lg bg-muted/30">
                <TrendingUp className="w-4 h-4 text-levelup mb-1" />
                <span className="text-lg font-bold text-foreground tabular-nums">
                  Lv.{stats.level || 1}
                </span>
