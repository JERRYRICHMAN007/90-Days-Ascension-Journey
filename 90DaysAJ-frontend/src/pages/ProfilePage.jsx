        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <Card className="p-6 bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <Button
                variant="outline"
                className="w-full mb-3 border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 dark:border-blue-500 dark:text-blue-400"
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6 bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Showcase your achievements and badges to demonstrate your progress and accomplishments in your ascension journey.
                </p>
              </div>
            ...
            {domainLevels.length > 0 && (
              <Card className="p-6 bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Domain Levels</h2>
                <div className="space-y-4">
                  {domainLevels.map(({ domain, level }) => (
                    <div key={domain} className="pb-4 border-b border-gray-200 dark:border-gray-700 last:border-0 last:pb-0">
