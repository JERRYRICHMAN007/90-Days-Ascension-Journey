...
export const journeys = [
  {
    ...
    description: "6-month physical discipline — strength, energy, and consistency",
  ...
  },
  {
    ...
    description: "Personal brand + business brand — grow audience and revenue over 6 months",
    totalDays: JOURNEY_TOTAL_DAYS,
    color: "#f093fb",
  },
  {
    ...
    description: "6 books over 6 months — reading that sharpens how you think and act",
    totalDays: JOURNEY_TOTAL_DAYS,
    color: "#4facfe",
  },
  {
    ...
    description: "6-month writing practice — publish, refine, and build an audience",
    totalDays: JOURNEY_TOTAL_DAYS,
    color: "#43e97b",
  },
  {
...
export function getWeekTheme(weekNum) {
  const themes = {
    ...
    14: "Leverage Phase - Systematize income and launch your product",
    15: "Scale Phase - Brand at full execution, capstone in progress",
    16: "Completion Phase - Ship capstone, strengthen body, publish writing",
