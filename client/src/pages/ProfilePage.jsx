  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-muted-foreground text-sm mt-1">Your Aether identity and stats</p>
      </motion.div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6 glass-panel border-border/50">
              ...
              <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-border">
                <p className="text-sm text-muted-foreground">
                  Showcase your achievements and badges to demonstrate your progress and accomplishments in your Aether journey.
                </p>
              </div>
